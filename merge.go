...
func MergeFiles(fset *token.FileSet, files map[string]*ast.File, pkgname string) (*ast.File, error) {
	var names []string
...
func addImport(f *ast.File, ipath string) (added bool) {
	...
	fmt.Println("Adding new import", newImport.Path.Value)
